...
numberOfrates=soup.findAll('span',class_='s-item__reviews-count')
ratings=soup.findAll('div',class_='b-starrating')
nextPagesLink=soup.find('a',class_='pagination__next')
